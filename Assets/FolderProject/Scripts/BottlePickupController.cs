...
public class BottlePickupController : MonoBehaviour
{
    ...
    //To pick up the gun an initialize his position
     private void PickUp()
    {
        ...
        transform.localPosition = new Vector3(-3.24f,-2,0) ;
        transform.localRotation = Quaternion.Euler(new Vector3(263.9f,5.4f,0) );
